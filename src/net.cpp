...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "POcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"stratum.dexterdemmink.com", "37.247.116.22"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"pocointools.com", "testnet-seed.pocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. POcoin is probably already running."), addrBind.ToString().c_str());
        else
